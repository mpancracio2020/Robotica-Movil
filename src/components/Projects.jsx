  ...
  return (
    <Element name={"Projects"} id="projects">
      <section className="section">
        <Container>
          ...
          { /*fefe*/} 
            <div>
            <h1>Basic Vacuum Cleane</h1>
            <div className="accordion">
              {accordionData.map(({ title, content }) => (
                <Accordion title={'More content'} style={{ backgroundColor: '#343a40' }} 
                  content={
    ...
    { /*fefe*/}             
          ...
          { /*fefe*/} 
            ...
            <div className="accordion">
              {accordionData.map(({ title, content }) => (
                <Accordion title={'Basic Vacuum Cleaner' <i class="solar:smart-vacuum-cleaner-outline"></i>} style={{ backgroundColor: '#343a40' }} 
                  content={
                  <p>This practice consists of developing an iterative pseudo-navigation algorithm.
                        I have used the bumper and laser sensor to avoid collisions. The laser will predominate in the measurements, 
                        but it may be the case that in some turns it does not sense a corner and that is where the bumper comes into play.
    ...
    { /*fefe*/}  
          ...
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Basic Vacuum Cleaner</a>
                </h4>
               </div>
